...
exports.splitItemDescription = splitItemDescription;
exports.formatQuoteLineDescription = formatQuoteLineDescription;
exports.formatQuoteLineImageCaption = formatQuoteLineImageCaption;
...
function formatQuoteLineDescription(item) {
    const lines = [];
...
function formatQuoteLineImageCaption(item) {
